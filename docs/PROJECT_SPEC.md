...
| G8 | Tab Aiuto: check aggiornamenti all'avvio (messaggio se disponibile, tab evidenziata "Aiuto ●"), Aggiorna (procedura guidata), Apri cartella log, Segnala bug (issue GitHub precompilata); dialog crash con Apri log e Segnala errore | P1 ✓ |
